...
CREATE INDEX IF NOT EXISTS idx_playback_commands_created_at ON playback_commands(created_at DESC);
...
GRANT USAGE ON SEQUENCE playback_commands_id_seq TO authenticated; 